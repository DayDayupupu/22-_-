...
parser.add_argument('--rgb_root', type=str, default='E:/guobiao/CIRNet_TIP2022-main/data/RGBD_for_train/RGB/',
                    help='the training rgb images root')
parser.add_argument('--depth_root', type=str, default='E:/guobiao/CIRNet_TIP2022-main/data/RGBD_for_train/depth/',
                    help='the training depth images root')
parser.add_argument('--gt_root', type=str, default='E:/guobiao/CIRNet_TIP2022-main/data/RGBD_for_train/GT/',
...
parser.add_argument('--test_path', type=str, default='E:/guobiao/CIRNet_TIP2022-main/data/RGBD_for_test/', help='test dataset path')
